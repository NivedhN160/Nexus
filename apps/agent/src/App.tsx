...
import TerraXLab from './components/TerraXLab';
  ...
  return (
    <div className="nexus-layout">
      ...
      <main className="main-stage">
        ...
        {activeTab !== 'agent' && activeTab !== 'social' && activeTab !== 'leads' && activeTab !== 'audit' && activeTab !== 'labs' && activeTab !== 'terra-x' && activeTab !== 'stock' && (
        ...
        {activeTab === 'labs' && <LabsIndex onOpenLab={(id) => setActiveTab(id)} />}
        {activeTab === 'terra-x' && <TerraXLab onBack={() => setActiveTab('labs')} />}
        {activeTab === 'stock' && <StockLab onBack={() => setActiveTab('labs')} />}
      </main>
